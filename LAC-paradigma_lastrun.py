...
pos=[0.0, -0.4], 
low=1, high=7, 
labels=['gar nicht intensiv', ' sehr intensiv'], 
scale='Intensivität', 
markerStart='4', 
acceptKeys='space')
...
pos=[0.0, -0.4], 
low=1, high=7, 
labels=['gar nicht angenehm', ' sehr angenehm'], 
...
pos=[0.0, -0.4], 
low=1, high=7, 
labels=['gar nicht bekannt', ' sehr bekannt'], 
scale='Bekanntheit', 
markerStart='4', 
acceptKeys='space')
familarity_text = visual.TextStim(win=win, name='familarity_text',
    text='Wie bekannt ist Ihnen dieser Geruch?',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    text_odor_DEBUG.setText(f"{odor} auf {channel}")
    # keep track of which components have finished
